...
2. **Generator** (optional): module that receives quantum tasks and performs circuit-cutting
   techniques to partition large, highly entangled quantum circuits into a set of sub-circuits.
...
6. **Knitter** (optional): module that receives all the sub-circuits generated by the generator
   module from a large, highly entangled quantum circuit. Here, the results of sub-circuits
   belonging are combined via knitting techniques to get the results of the large, highly entangled
   quantum circuit previously partitioned by the generator.
