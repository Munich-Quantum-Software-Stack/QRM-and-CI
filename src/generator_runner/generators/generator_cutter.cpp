                              ...
                              const int task_id)
{
    ...
    childQuantumTask.duration = parentQuantumTask.duration;
    childQuantumTask.end = parentQuantumTask.end;
    childQuantumTask.age = parentQuantumTask.age;
...
generator(const QuantumTask &parentQuantumTask)
{
    ...
    int N = 5; // Desired number of children
    ...
    for (int i = 0; i < N; ++i)
    {
        ...
        childQuantumTasks.push_back(
            createQuantumTask(M, TSCtx, parentQuantumTask, i));
    }
