...
/* Function to assign rank and crowding distance to a population of size
 * pop_size*/
    ...
    do
    {
        ...
        do
        {
            ...
            do
            {
                ...
                flag =
                    check_dominance(nsga2Params, &(new_pop->ind[temp1->index]),
        ...
        assign_crowding_distance_list(nsga2Params, new_pop, cur->child,
                                      front_size);
        temp2 = cur->child;
        do
        {
