...
#include "../headers/QirXGateAndHadamardSwitch.hpp"
 ...
 */
PreservedAnalyses QirXGateAndHadamardSwitchPass::run(
...
/**
 * @brief External function for loading the 'QirXGateAndHadamardSwitchPass' as a
 * 'PassModule'.
