/**
 * @file QirHadamardAndXGateSwitch.cpp
 * @brief Implementation of the 'QirHadamardAndXGateSwitchPass' class. <a
...
#include "../headers/QirHadamardAndXGateSwitch.hpp"
 ...
 */
PreservedAnalyses QirHadamardAndXGateSwitchPass::run(
...
/**
 * @brief External function for loading the 'QirHadamardAndXGateSwitchPass' as a
 * 'PassModule'.
