 ...
 * @brief Implementation of the 'QirCommuteCnotRxPass' class. <a
 * href="https://gitlab-int.srv.lrz.de/lrz-qct-qis/quantum_intermediate_representation/qir_passes/-/blob/Plugins/src/passes/QirCommuteCnotRx.cpp?ref_type=heads">Go
...
/**
 * @brief External function for loading the 'QirCommuteCnotRxPass' as a
 * 'PassModule'.
